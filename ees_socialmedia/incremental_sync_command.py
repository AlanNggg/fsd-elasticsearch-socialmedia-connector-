...
class IncrementalSyncCommand(BaseCommand):
    ...
    def start_producer(self, documents_to_index, time_range):
        ...
        try:   
            ...
            for collection in self.config.get_value("socialmedia.collections"):
                ...
                try:
                    storage_with_collection["global_keys"][collection] = sync_socialmedia.perform_sync(collection)
    ...
    def execute(self):
        ...
        start_time, end_time = checkpoint.get_checkpoint(current_time, 'youtube')
        time_range = {
        ...
        checkpoint.set_checkpoint(current_time, INDEXING_TYPE, 'youtube')
